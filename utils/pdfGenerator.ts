    ...
    <div style="margin-top: 40px; page-break-inside: avoid;">
      <div style="background: linear-gradient(135deg, #064E3B 0%, #065F46 100%);
        ...
        <div style="background: rgba(14,165,233,0.22); border: 1.5px solid #38BDF8; border-radius: 10px; padding: 20px; text-align: center; margin-bottom: 20px;">
          ...
          <div style="font-size: 16px; color: #BAE6FD; margin-top: 4px;">(${roi.roiAnos} años)</div>
        </div>
        ...
        <p style="margin: 16px 0 0 0; font-size: 10px; color: #6EE7B7; font-style: italic; text-align: center;">
          * Estimado con tarifa ${roi.tarifa} a $${roi.precioKwh}/kWh y PR=80%. No incluye incrementos tarifarios anuales (~5%). Sin considerar depreciación de equipo.
        </p>
      </div>
    </div>
  ` : '';
